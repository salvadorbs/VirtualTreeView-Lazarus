...
uses
  LCLIntf, SysUtils, Classes, Graphics, Controls, Forms, VirtualTrees.BaseTree,
  Dialogs, VirtualTrees, StdCtrls, LResources, Buttons, VirtualTrees.Types, VirtualTrees.Header;
