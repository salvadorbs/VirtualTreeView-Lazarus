...
interface
   ...
   uses
      Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, VirtualTrees.BaseTree,
      Dialogs, VirtualTrees, ImgList, ExtCtrls, StdCtrls, Buttons, LResources, VirtualTrees.Types;
