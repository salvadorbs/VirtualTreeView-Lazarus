...
interface
   ...
   uses
      ...
      Dialogs, VirtualTrees, ExtCtrls, StdCtrls, Buttons, LResources, VirtualTrees.BaseTree;
...
implementation
   ...
   uses
      VTNoData, VTCheckList, VTPropEdit, VTDBExample, VTEditors, ViewCode,  VirtualTrees.Types;
